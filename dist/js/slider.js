...
function changeColors(currentSlide){
  // Mudar cor caso o slide seja maior que o primeiro e a cor esteja clara
  if(currentSlide > 1){
    var menu_lines = document.querySelectorAll(".btn-line");
    var slider_indicators = document.querySelectorAll(".slider__indicator");
    menu_lines.forEach(line => line.style.background = "#2f2f2f")
    slider_indicators.forEach(line => line.style.background = "#2f2f2f")
  }

  // Mudar cor caso o slide seja o primeiro e a cor esteja escura
  if(currentSlide == 1){
    var menu_lines = document.querySelectorAll(".btn-line");
    var slider_indicators = document.querySelectorAll(".slider__indicator");
    menu_lines.forEach(line => line.style.background = "#e8e8e8")
    slider_indicators.forEach(line => line.style.background = "#e8e8e8")
  }
}